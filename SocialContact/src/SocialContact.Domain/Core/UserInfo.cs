namespace SocialContact.Domain.Core{
    ...
    public class UserInfo : Entry {
        ...
        [Utility.Range(Min =5,Max =15,Message = "请输入长度在 5 到 15 个字符账户")]
        public virtual string Account { get; set; }
        [Utility.Required(Message = "请输入密码")]
        [Utility.Range(Min = 6, Max = 20, Message = "请输入长度在 6 到 20 个字符密码")]
        public virtual string Password { get; set; }
        [Utility.Required(Message = "请输入昵称")]
        [Utility.Range(Min = 2, Max = 10, Message = "请输入长度在 2 到 10 个字符昵称")]
        [FromForm(Name ="nick_name")]
        public virtual string NickName { get; set; }
        [Utility.Required(Message = "请输入姓名")]
        [Utility.Range(Min = 2, Max = 10, Message = "请输入长度在 2 到 10 个字符姓名")]
        ...
        [Utility.Range(Min = 11, Max = 11, Message = "请输入长度在 11 个数字手机号")]
        public virtual string Phone { get; set; }
        [Utility.Required(Message = "请选择性别")]
        ...
        [Utility.Range(Min = 10, Max = 500, Message = "请输入长度在 10 到 500 个字符描述")]
        public virtual string Description { get; set; }
        [Utility.Required(Message = "请输入邮箱")]
        [Utility.Range(Min = 10, Max = 20, Message = "请输入长度在 10 到 20 个字符邮箱")]
        public virtual string Email { get; set; }
        [Utility.Required(Message = "请输入身份证号")]
        [Utility.Range(Min = 17, Max = 18, Message = "请输入长度在 17 到 18 个字符身份证号")]
        ...
        [Utility.Required(Message = "请输入银行卡号")]
        [Utility.Range(Min = 20, Max = 20, Message = "请输入长度在 20 位数字银行卡号")]
