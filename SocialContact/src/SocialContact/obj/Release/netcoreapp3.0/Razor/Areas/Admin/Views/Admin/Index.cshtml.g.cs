#pragma checksum "E:\work\program\SocialContact\src\SocialContact\Areas\Admin\Views\Admin\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "c130fd8d52ace602b35df4284bf3d6144b51efff"
// <auto-generated/>
...
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"c130fd8d52ace602b35df4284bf3d6144b51efff", @"/Areas/Admin/Views/Admin/Index.cshtml")]
    public class Areas_Admin_Views_Admin_Index : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        ...
        public async override global::System.Threading.Tasks.Task ExecuteAsync()
        {
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("head", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "c130fd8d52ace602b35df4284bf3d6144b51efff2768", async() => {
                WriteLiteral(@"
    <meta charset=""utf-8"">
    ...
    <style>
      ...
      ");
            ...
            WriteLiteral("\r\n");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("body", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "c130fd8d52ace602b35df4284bf3d6144b51efff5084", async() => {
                WriteLiteral(@"
    <div class=""admin_list"">
        ...
        <el-form :inline=""true"" :model=""formQuery"" ref=""formQuery"" class=""demo-form-inline "">
            ...
            <el-form-item label=""出生日期范围"" prop=""birthday_date"">
                <el-date-picker v-model=""formQuery.birthday_date"" type=""datetimerange"" value-format=""yyyy-MM-dd"" :picker-options=""createDatePickerOptions""
                                range-sepa");
                WriteLiteral(@"rator=""至"" start-placeholder=""开始日期"" align=""right"">
                </el-date-picker>
            </el-form-item>
            ...
            <el-form-item label=""邮箱"" prop=""email"">
                <el-input v-model=""formQuery.email"" placeholder=");
                WriteLiteral(@"""邮箱""></el-input>
            </el-form-item>
            ...
            <el-form-item label=""修改时间范围"" prop=""update_date"">
                <el-date-picker v-model=""formQuery.update_date"" type=""datetimerange"" value-format=""yyyy-MM-dd HH:mm:ss"" :picker-options=""createDatePicker");
                WriteLiteral(@"Options"" range-separator=""至"" start-placeholder=""开始日期""
        ...
        <el-table v-loading=""loading"" element-loading-spinner=""el-icon-loading""
            ...
            <el-table-column prop=""role"" label=""角色信息"" align=""center"">
                ...
                WriteLiteral(@"=""role.category"" label=""角色名称"" width=""80"" align=""center""> </el-table-column>
            </el-table-column>
            ...
            <el-table-column prop=""head_pic"" label=""头像"" width=""200"" align=""center"">
                <template slot-scope=""scope"">
                    <img v-if=""scope.row.head_pic"" :src=""baseUrl+'img/'+scope.row.head_pic"" align=""middle"" clas");
                WriteLiteral(@"s=""avatar"">
            ...
            <el-table-column prop=""create_date"" label=""创建日期"" align=""center"" so");
                WriteLiteral(@"rtable width=""200"">
                <template slot-scope=""scope"">
                    <i class=""el-icon-time""></i>
            ...
            <el-table-column ");
                WriteLiteral(" label=\"操作\" width=\"100\" align=\"center\">\r\n                <template slot-scope=\"scope\">\r\n                    <el-button ");
        ...
        <el-dialog :title=""dialog.title"" :visible.sync=""dialog.visible"" width=""30%"" :before-close=""handleDialogClose"">
            ...
            <el-form :model=""formSubmit"" status-icon :rules=""formRoleValidator"" ref=""formSubmit"" enctype=""multipart/form-data"" :disabled=""disabled"" class=""demo-ruleForm"" :label-position=""labelPosition"" ");
                WriteLiteral(@"label-width=""80px"">
                ...
                <el-form-item label=""角色"" prop=""role.id"">
                    <el-cascader v-model=""formSubmit.role.id"" placeholder=""角色分类"" ref=""refHandleForm""
                                 ...
                                 :props=""{  checkStrictly: true,expandTrigger: 'hover' }""
                                 ");
                WriteLiteral("@change=\"handleRoleFormChangeEvent\" ");
                WriteLiteral("@visible-change=\"handleRoleVisableChangeEvent\" clearable>\r\n                        <template slot-scope=\"{ node, data }\">\r\n                            <span style=\"float: left\" ");
                WriteLiteral(@"@click=""handleRoleFormClickEvent(data.value)"">{{ data.label }}</span>
                            <span v-if=""!node.isLeaf""> ({{ data.children.length }}) </span>
                        </template>
                    </el-cascader>
                </el-form-item>
  ...
  ");
                WriteLiteral(@"              <el-form-item label=""描述"" prop=""description"">
    ...
    <script>
        ...
        obj.data.formRoleValidator = {
            ...
            role: {
                id: {
                    validator: (rule, value, callback) => {
                        if (");
                WriteLiteral(@"obj.data.required_role) {
                            if (!value) {
            ...
            phone: [
                ...
                WriteLiteral(@"请输入手机号', trigger: 'blur' },
            ...
            password: [
                ...
                // { min: 6, max: 20, message: '长度在 6 到 20 个字符密码', trigger: 'blur' }
                {
                   ...
                   ");
                WriteLiteral(@"     else if (obj.data.old_pwd != value && (value.length < 6 || value.length > 20)) {
   ...
   ");
        ...
        obj.methods.onChange = function (file, fileList) {
            ...
            this.fileInfo = file;
      ");
                WriteLiteral(@"      this.head_pic_name = file.name;
        ...
        obj.methods.setValue = function (row) {
            ...
            if (row.head_pic) {
                ...
                this.formSubmit.admin_pic.file_id = row.head_pi");
