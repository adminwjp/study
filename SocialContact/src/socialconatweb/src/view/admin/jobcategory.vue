...
<script>
import query from "../../components/admin/jobcategory/query";
import tableList from "../../components/admin/jobcategory/tableList";
import operator from "../../components/admin/operator";
import page from "../../components/admin/page";
import dialogForm from "../../components/admin/jobcategory/dialogForm";
import {
...
var obj = new Gibson();
obj.el = ".job_category_list";
obj.data.operatorUrl = { add: urls.jobcategory.add, modify: urls.jobcategory.edit, delete: urls.jobcategory.delete, query: urls.jobcategory.query };
obj.data.formQuery = { id: "", category: "", create_date: [], update_date: [] };
obj.data.formSubmit = { id: "", category: "", description: "这个人很懒,什么也没留下!" };
obj.data.controller = "jobcategory";
