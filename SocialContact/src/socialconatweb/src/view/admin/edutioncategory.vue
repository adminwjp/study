<template>
  <div>
    <query
      ref="query"
      :formQuery="formQuery" :options="options"
...
<script>
import query from "../../components/admin/edutioncategory/query";
import tableList from "../../components/admin/edutioncategory/tableList";
import operator from "../../components/admin/operator";
import page from "../../components/admin/page";
import dialogForm from "../../components/admin/edutioncategory/dialogForm";
import {
...
var obj = new Gibson();
obj.el = ".edution_category_list";
obj.data.operatorUrl = { add: urls.edutioncategory.add, modify: urls.edutioncategory.edit, delete: urls.edutioncategory.delete, query: urls.edutioncategory.query };
obj.data.formQuery = { id: "", category: "", create_date: [], update_date: [] };
obj.data.formSubmit = { id: "", category: "", description: "这个人很懒,什么也没留下!" };
obj.data.controller = "edutioncategory";
obj.data.isOperatorRequest = true;
obj.data.formRoleValidator = {
  category: [
    { required: true, message: "请输入学历分类名称", trigger: "blur" },
    { min: 2, max: 10, message: "长度在 2 到 10 个字符学历分类名称", trigger: "blur" }
  ],
  description: [
