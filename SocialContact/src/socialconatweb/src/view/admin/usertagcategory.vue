...
<script>
import query from "../../components/admin/usertagcategory/query";
import tableList from "../../components/admin/usertagcategory/tableList";
import operator from "../../components/admin/operator";
import page from "../../components/admin/page";
import dialogForm from "../../components/admin/usertagcategory/dialogForm";
import {
...
var obj = new Gibson();
obj.el = ".user_tag_category_list";
obj.data.operatorUrl = { add: urls.usertagcategory.add, modify: urls.usertagcategory.edit, delete: urls.usertagcategory.delete, query: urls.usertagcategory.query };
obj.data.formQuery = { id: "", category: "", create_date: [], update_date: [] };
obj.data.formSubmit = { id: "", category: "", description: "这个人很懒,什么也没留下!" };
obj.data.controller = "usertagcategory";
