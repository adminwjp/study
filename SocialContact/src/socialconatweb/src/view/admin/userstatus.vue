...
<script>
import query from "../../components/admin/userstatus/query";
import tableList from "../../components/admin/userstatus/tableList";
import operator from "../../components/admin/operator";
import page from "../../components/admin/page";
import dialogForm from "../../components/admin/userstatus/dialogForm";
import {
...
var obj = new Gibson();
obj.el = ".user_status_list";
obj.data.operatorUrl = { add: urls.userstatus.add, modify: urls.userstatus.edit, delete: urls.userstatus.delete, query: urls.userstatus.query };
obj.data.formQuery = {id: "", name: "", create_date: [], update_date: []};
obj.data.formSubmit = { id: "", name: "", description: "这个人很懒,什么也没留下!" };
obj.data.controller = "userstatus";
