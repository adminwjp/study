<template>
        ...
        :data="tableData" tooltip-effect="dark"
            ...
            <el-table-column prop="category" label="文件分类名称" width="200"> </el-table-column>
            <el-table-column prop="accept" label="文件后缀" width="200"> </el-table-column>
            <el-table-column prop="description" label="学历描述" width="300"> </el-table-column>
