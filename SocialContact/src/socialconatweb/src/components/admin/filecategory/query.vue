<template>
        ...
        <el-form :inline="true" :model="formQuery" ref="formQuery" class="demo-form-inline query ">
            ...
            <el-form-item label="文件分类名称" prop="category">
                <el-input v-model="formQuery.category" placeholder="文件分类名称"></el-input>
            </el-form-item>
            <el-form-item label="创建时间范围" prop="create_date">
                <el-date-picker v-model="formQuery.create_date" type="datetimerange" :picker-options="createDatePickerOptions"
                                range-separator="至" start-placeholder="开始日期" align="right">
                </el-date-picker>
            </el-form-item>
            <el-form-item label="修改时间范围" prop="update_date">
                <el-date-picker v-model="formQuery.update_date" type="datetimerange" :picker-options="createDatePickerOptions" range-separator="至" start-placeholder="开始日期"
...
export default {
  name: "query",
  props: ["formQuery", "createDatePickerOptions", "options"],
  data: function() {
    return {
