...
namespace SocialContact.Api.Areas.Admin.Controllers
{
    ...
    {
        public UserLevelController(RedisCache redisCache, IUnitWork unitWork, IMemoryCache cache, AuthrizeValidator authrize, ILogger<UserLevelController> logger) : base(redisCache, unitWork,cache, authrize, logger)
        {
