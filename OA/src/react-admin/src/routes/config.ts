        ...
        },
        {
            ...
            subs: [
                ...
                },
                {
                    ...
                    key: '/app/admin/accountItem',
                    title: '考勤/账套项目',
                    component: 'AccountItem',
                },
                {
                    key: '/app/admin/bringUpContent',
                    title: '培训内容',
                    component: 'BringUpContent',
                }, 
                {
                    key: '/app/admin/reckoningName',
                    title: '账套名称 ',
                    component: 'ReckoningName',
                }, {
                    key: '/app/admin/person',
                    title: '员工信息 ',
                    component: 'Person',
                }, {
                    key: '/app/admin/timeCard',
                    title: '考勤 ',
                    component: 'TimeCard',
                }, {
                    key: '/app/admin/reckoningList',
                    title: '账套人员设置 ',
                    component: 'ReckoningList',
                }, {
                    key: '/app/admin/reckoning',
                    title: '账套信息 ',
                    component: 'Reckoning',
                }, {
                    key: '/app/admin/reawrdsAndPunishment',
                    title: '奖惩信息 ',
                    component: 'ReawrdsAndPunishment',
                }, {
                    key: '/app/admin/module',
                    title: '模块 ',
                    component: 'Module',
                }, {
                    key: '/app/admin/duty',
                    ...
                    key: '/app/admin/bringUpPerson',
                    title: '培训人员 ',
                    component: 'BringUpPerson',
                }, {
                    key: '/app/admin/authority',
                    title: '角色权限 ',
                    component: 'Authority',
                }, {
                    key: '/app/admin/record',
                    title: '员工档案 ',
                    component: 'Record',
                } 
            ],
