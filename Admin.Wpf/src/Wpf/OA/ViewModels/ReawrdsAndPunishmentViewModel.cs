...
namespace OA.Wpf.ViewModels
{
    ...
    /// 奖惩信息
    /// </summary>
    [MappTypeAttribute(typeof(ReawrdsAndPunishmentInfo))]
    public class ReawrdsAndPunishmentViewModel : ReawrdsAndPunishmentInfo, INotifyPropertyChanged, IIsSelectedViewModel
    {
